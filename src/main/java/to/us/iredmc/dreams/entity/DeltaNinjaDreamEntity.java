...
import to.us.iredmc.dreams.entity.renderer.DeltaNinjaDreamRenderer;
...
public class DeltaNinjaDreamEntity extends DreamsModElements.ModElement {
	...
	public DeltaNinjaDreamEntity(DreamsModElements instance) {
		super(instance, 7);
		FMLJavaModLoadingContext.get().getModEventBus().register(new DeltaNinjaDreamRenderer.ModelRegisterHandler());
