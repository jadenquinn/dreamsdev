...
import to.us.iredmc.dreams.procedures.BadboyhaloItIsStruckByLightningProcedure;
import to.us.iredmc.dreams.itemgroup.DreamsItemGroup;
import to.us.iredmc.dreams.entity.renderer.BadboyhaloRenderer;
...
public class BadboyhaloEntity extends DreamsModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("dreams:entitybulletbadboyhalo")
	public static final EntityType arrow = null;
	public BadboyhaloEntity(DreamsModElements instance) {
		super(instance, 9);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BadboyhaloRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(70).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("badboyhalo")
						.setRegistryName("badboyhalo");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -12509409, -1, new Item.Properties().group(DreamsItemGroup.tab))
				.setRegistryName("badboyhalo_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletbadboyhalo").setRegistryName("entitybulletbadboyhalo"));
	}
	...
	public static class CustomEntity extends AnimalEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 8;
			setNoAI(false);
			setCustomName(new StringTextComponent("BadBoyHalo"));
			setCustomNameVisible(true);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.BOW, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Items.SPECTRAL_ARROW, (int) (1)));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.SPECTRAL_ARROW, (int) (1)));
		}
		...
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dreams:baddead1"));
		}
		...
		public void func_241841_a(ServerWorld serverWorld, LightningBoltEntity entityLightningBolt) {
			...
			Entity entity = this;
			{
				...
				BadboyhaloItIsStruckByLightningProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Items.EMERALD, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
	}
