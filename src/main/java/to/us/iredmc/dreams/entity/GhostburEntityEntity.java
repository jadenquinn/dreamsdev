...
import to.us.iredmc.dreams.procedures.GhostburEntityItIsStruckByLightningProcedure;
import to.us.iredmc.dreams.itemgroup.DreamsItemGroup;
import to.us.iredmc.dreams.entity.renderer.GhostburEntityRenderer;
...
public class GhostburEntityEntity extends DreamsModElements.ModElement {
	...
	public GhostburEntityEntity(DreamsModElements instance) {
		super(instance, 25);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GhostburEntityRenderer.ModelRegisterHandler());
