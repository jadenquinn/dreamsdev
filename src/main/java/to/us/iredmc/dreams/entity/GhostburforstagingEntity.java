...
import to.us.iredmc.dreams.entity.renderer.GhostburforstagingRenderer;
...
public class GhostburforstagingEntity extends DreamsModElements.ModElement {
	...
	public GhostburforstagingEntity(DreamsModElements instance) {
		super(instance, 36);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GhostburforstagingRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("ghostburforstaging")
						.setRegistryName("ghostburforstaging");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -3355444, -10066330, new Item.Properties().group(DreamsItemGroup.tab))
				.setRegistryName("ghostburforstaging_spawn_egg"));
	}
