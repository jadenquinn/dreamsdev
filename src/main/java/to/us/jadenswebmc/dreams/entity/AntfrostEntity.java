...
import to.us.jadenswebmc.dreams.procedures.AntfrostItIsStruckByLightningProcedure;
import to.us.jadenswebmc.dreams.procedures.AntfrostEntityDiesProcedure;
...
public class AntfrostEntity extends DreamsModElements.ModElement {
	public static EntityType entity = null;
	@ObjectHolder("dreams:entitybulletantfrost")
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(56).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("antfrost")
						.setRegistryName("antfrost");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13421824, -10066330, new Item.Properties().group(DreamsItemGroup.tab))
				.setRegistryName("antfrost_spawn_egg"));
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
				.size(0.5f, 0.5f)).build("entitybulletantfrost").setRegistryName("entitybulletantfrost"));
	}
	...
	public static class CustomEntity extends CreatureEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			setCustomName(new StringTextComponent("Antfrost"));
			setCustomNameVisible(true);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Blocks.LIME_BED, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(Items.DIAMOND_SHOVEL, (int) (1)));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.EXPERIENCE_BOTTLE, (int) (1)));
		}

		@Override
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dreams:georgedrinkingstahp"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dreams:georgehurt"));
		}
		...
		public void func_241841_a(ServerWorld serverWorld, LightningBoltEntity entityLightningBolt) {
			...
			Entity entity = this;
			{
				...
				AntfrostItIsStruckByLightningProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				AntfrostEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 2; ++l) {
					double d0 = (double) ((float) x + 0.5) + (double) (random.nextFloat() - 0.5) * 0.3999999985098839D;
					double d1 = ((double) ((float) y + 0.7) + (double) (random.nextFloat() - 0.5) * 0.3999999985098839D) + 0.5;
					double d2 = (double) ((float) z + 0.5) + (double) (random.nextFloat() - 0.5) * 0.3999999985098839D;
	...
	private static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Items.MUSIC_DISC_CAT, (int) (1));
		}
